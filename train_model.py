...
class Trainer():
    def __init__(self, model, conf, device):
        ...
        train_batch_sampler = BalancedBatchSampler(origin_train_dataset, batch_size=conf["Model"]["batch_size"], n_classes=conf["Model"]["n_classes"], n_samples=conf["Model"]["batch_size"]//conf["Model"]["n_classes"])
