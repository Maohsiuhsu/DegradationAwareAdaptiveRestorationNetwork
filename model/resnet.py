...
class ResNet18(nn.Module):
    def __init__(self, layers=[2, 2, 2, 2], num_classes=512, zero_init_residual=False, groups=1, width_per_group=64, replace_stride_with_dilation=None, norm_layer=None):
        ...
        #     self.fc = NormLinear(512 * BasicBlock.expansion, num_classes)
